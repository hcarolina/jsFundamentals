...
/*
    - when javascript sees that we're trying to add together a number and a srting, instead of using the built in math functionality, it will instead use concatenation to combine the values instead of trying to synthesize the values.
*/
console.log(third);
...
let houseNumber ='1824';
let street = 'Hamilton ln';
let city = 'Carmel';
let state = 'In';
let zipcode = '46032';
